<template>
  <div class="monitoreo-container">
    ...
    <div class="filtros">
      <div class="filtro">
        ...
        <select v-model="tipoProduccion" id="tipoProduccion" @change="actualizarDatos">
          ...
          <option value="gas">Gas</option> <!-- Opción adicional -->
    ...
    <h2 class="subtitulo">Alertas de Consumo</h2>
...
<script>
import LineChart from '../components/ConsumoGrafico.vue';
import AlertaConsumo from '../components/AlertaConsumo.vue';
...
export default {
      ...
      consumoData: {
        ...
        datasets: [
          ...
          },
          {
            ...
            borderWidth: 1,
            data: [20, 30, 40, 50, 60, 70], // Datos simulados para gas
          },
        ],
      },
      dispositivos: [
        ...
        { id: 3, nombre: 'Dispositivo 3', consumo: 50, tipoDeRecurso: 'Gas' }, // Dispositivo de gas
  ...
  computed: {
    ...
    totalConsumoGas() {
      return this.consumoData.datasets[2].data.reduce((a, b) => a + b, 0); // Cálculo para gas
    },
  },
  methods: {
    actualizarDatos() {
    ...
    simularActualizacionDatos() {
      ...
      if (this.tipoProduccion === 'electricidad') {
        ...
        this.consumoData.datasets[2].data = [0, 0, 0, 0, 0, 0]; // No hay datos de gas
        ...
        this.consumoData.datasets[0].data = [0, 0, 0, 0, 0, 0]; // No hay datos de electricidad
        this.consumoData.datasets[1].data = [0, 0, 0, 0, 0, 0]; // No hay datos de agua
        this.consumoData.datasets[2].data = [30, 40, 50, 60, 70, 80]; // Simulando datos nuevos para gas
      }
    },
  },
};
